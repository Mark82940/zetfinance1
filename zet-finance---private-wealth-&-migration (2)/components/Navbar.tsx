  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        {/* Mobile Actions (Button + Toggle) */}
        <div className="flex items-center gap-3 md:hidden">
          <button 
            onClick={() => onNavigate('callback')}
            className="bg-brand-gold text-brand-navy font-bold px-4 py-2 rounded-sm text-xs uppercase tracking-widest flex items-center gap-2 shadow-md hover:bg-amber-500 transition-colors"
          >
            <Phone className="w-3 h-3" />
            <span>Call</span>
          </button>
