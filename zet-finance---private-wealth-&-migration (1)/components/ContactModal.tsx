...
import { Shield, X, Send, CheckCircle2, Info, ArrowRight, Lock, Mail } from 'lucide-react';
                     ...
                     >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                           ...
                           <div className="space-y-3 pt-2">
                             <button 
                               type="submit" 
                               className="w-full bg-brand-navy hover:bg-brand-gold hover:text-brand-navy text-white font-bold py-5 rounded-sm transition-all duration-300 flex items-center justify-center gap-2 shadow-xl shadow-brand-navy/10 text-sm uppercase tracking-widest"
                             >
                     ...
                     <div className="h-full flex flex-col items-center justify-center text-center space-y-6 animate-fade-in">
                        ...
                        <div>
                           ...
                           <p className="text-slate-500 text-sm max-w-xs mx-auto">
                              Thank you, <span className="font-bold text-brand-navy">{name}</span>. We have securely received your details.
                           </p>
                        </div>
