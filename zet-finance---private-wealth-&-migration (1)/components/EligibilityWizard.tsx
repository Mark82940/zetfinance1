  ...
  const renderForm = (interest: string) => (
    <form onSubmit={handleFormSubmit} className="space-y-4 pt-2">
        ...
        <button 
            type="submit" 
            disabled={submitting}
            className="w-full bg-brand-navy hover:bg-slate-800 text-white font-bold py-3 rounded-sm transition-all flex items-center justify-center gap-2 shadow-lg text-sm uppercase tracking-wide"
        >
